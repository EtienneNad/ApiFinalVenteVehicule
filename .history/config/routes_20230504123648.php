...
return function (App $app) {
    ...
    $app->get('/utilisateur/{id}', \App\Action\Utilisateur\AfficherUsagerIdAction::class);
    $app->get('/utilisateur/{username}&{motdepasse}', \App\Action\Utilisateur\AfficherUtilisateurCleAction::class);
