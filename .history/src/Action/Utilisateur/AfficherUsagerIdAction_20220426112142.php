...
use App\Domain\User\Service\AfficherUsager;
...
final class AfficherUsagerIdAction
{
    ...
    private $logger;
    public function __construct(AfficherUsager $AfficherUsagerId, LoggerFactory $loggerFactory)
    {
    ...
    public function __invoke(
        ...
        $usagerId = $request->getAttribute('id', 0);
        $Usager = $this->AfficherUsagerId->AfficherUsagerId($usagerId);
