...
namespace App\Domain\Animes\Service;

use App\Domain\Animes\Repository\AuthentificationBaseRepository;
...
final class AuthentificationBaseValidation
{
    ...
    public function TokenEstValide(string $token): bool
    {
        ...
        $motsPasse = str_replace('password:','',explode(' ', $decripteToken)[1] ?? '');
