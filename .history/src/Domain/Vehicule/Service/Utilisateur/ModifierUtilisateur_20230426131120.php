...
use App\Exception\RessourceNotFoundException as Ressourse;
...
final class ModifierUtilisateur
{
    ...
    private $repository;
     ...
     /**
     * @var RessourceNotFoundException
     */
    private $ressource;
     /// The constructor.
     ...
     */
    public function __construct(ModifierUtilisateurRepository $repository, LoggerFactory $logger , Ressourse $resource)
    {
    ...
    private function ValidationUtilisateur(int $id): void
    {
        ...
        if (empty($utilisateur)) {
             throw new Ressourse("Aucun utilisateur trouvé pour le id {$id}");
        }
    }
